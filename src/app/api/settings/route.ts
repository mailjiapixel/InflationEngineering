  ...
  try {
    ...
    if (!settings) {
      return NextResponse.json({
        brandName: process.env.NEXT_PUBLIC_STORE_NAME || "Inflation Engineering",
        contact: {
        ...
        marqueeText: "Welcome to Inflation Engineering!",
        metaTitle: process.env.NEXT_PUBLIC_STORE_NAME || "Inflation Engineering",
